...
new class extends Component {
    ...
    {
        $this->memberId = $id;
        $this->name = Member::findOrFail($id)->name;
    ...
    public function deleteMember()
    {
        try {
            ...
            $this->dispatch('success_member', message: 'Member deleted successfully!');
            ...
            $this->dispatch('error_member', message: $e->getMessage());
...
<div>
    <dialog wire:ignore.self id="modal-delete-member" @close-modal-delete-member.window="$el.close()" aria-labelledby="dialog-title" x-data={}
        ...
        <div tabindex="0"
            ...
            <div
                ...
                <form wire:submit="deleteMember" id="form-delete-member">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Are you sure you want to delete member <span
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 border-t border-gray-100">
                        ...
                        <button type="submit" wire:loading.attr="disabled" wire:target="deleteMember"
                            ...
                            <span wire:loading wire:target="deleteMember" class="flex items-center gap-2">
                                Deleting...
                            </span>
                        </button>

                        <button type="button" @click="document.getElementById('modal-delete-member').close()"
